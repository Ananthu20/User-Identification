					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<p class="mb-4">Nature is an important and integral part of mankind.It is one of the greatest blessings for human life.
								Survival of mankind without nature is impossible.Every form of nature,the plants, animals, 
								rivers, mountains, moon, and more holds equal significance for us.</p>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Health is wealth! Eating healthy food and following a healthy lifestyle can keep us healthy and happy.
								Food is extremely important for our body because we cannot live without it. we always have to eat nutritious food.
								 The food must contain natural elements that our body must grow properly.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Entertainment is an integral part of our daily life. After day long work we avidly seek entertainment. 
								It removes our boredom and boosts up our energy. Life without entertainment would be dull and dreary. 
								The type of entertainment depends on the nature of a person.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Sports and games are involved with brisk physical activities including various physical and tactical challenges.
								Sports and games is a field with bright career and interesting moments.It plays a great role in developing human personality. </p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Saving money simply means depositing some amount of money from your regular income so that the saved amount can be used at the time of urgency or for any other future use. 
								The amount of money that is left after spending on basic and essential expenditures can be referred as savings or saved money.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Filling fun and thrill in routine can be understood as an adventure. The future is unpredictable. 
								For some people, the meaning of adventure revolves around it.
								 Activities that performed without thinking of the outcomes can be defined as an adventure.
								 There is not a definite definition of adventure.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
